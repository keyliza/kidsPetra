...
/** Íconos Lucide (MIT) embebidos como SVG. Evita añadir una dependencia incompatible con Angular 22. */
...
@Component({
  ...
  template: `<svg xmlns="http://www.w3.org/2000/svg" [attr.width]="size()" [attr.height]="size()"
      viewBox="0 0 24 24" fill="none" stroke="currentColor" [attr.stroke-width]="stroke()"
...
export class IconComponent {
  ...
  svg(): SafeHtml {
    return this.sanitizer.bypassSecurityTrustHtml(PATHS[this.name()] ?? PATHS['sparkles']);
  }
}
